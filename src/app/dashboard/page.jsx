                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-4">
                        <div className="flex flex-col lg:items-start items-center pt-8 pb-12">
                            ...
                            <div className="flex justify-center sm:flex-row flex-col gap-4 mt-8">
                                ...
                                <a href="/about" className="sm:ml-4 text-primary text-center border border-primary font-bold hover:text-white hover:bg-primary p-4 rounded-full ">{t('learnMoreBtn')}</a>
                            </div>
                        </div>
